...
export const PessoaDetalhes: React.FC = () => {
  ...
  }, [id, user, legacyAccess, areaIds, ruaIdsExtras]);
          ...
          <div className="space-y-4">
            {atendimentos.length > 0 ? (
              atendimentos.map((visita) => (
                <div key={visita.id} className="bg-white rounded-2xl border border-slate-205 p-5 shadow-2xs overflow-hidden flex flex-col md:flex-row md:items-start justify-between gap-4">
